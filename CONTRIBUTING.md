...
1. Search [existing issues](https://github.com/kaushikanand-99/claude-session-handoff/issues) first.
...
Open a [Discussion](https://github.com/kaushikanand-99/claude-session-handoff/discussions) — happy to help.
